...
public class TelaEdicao extends JDialog 
{
    ...
    private JTextField input_descricao = new JTextField();
    ...
    private void updateComponents() 
    {
        ...
        input_descricao.setText( transacao.getComentario() );
    ...
    private void setPosicaoComponentes() 
    {
        ...
        label_descricao.setBounds(10, 210, 200, 25);
        input_descricao.setBounds(10, 235, 200, 25);
    ...
    private void setFonteComponentes() 
    {
        ...
        label_descricao.setFont(fonte2);
        input_descricao.setFont(fonte1);
    ...
    private void setCorCoponentes() 
    {
        ...
        label_descricao.setForeground(cor2);
        input_descricao.setForeground(cor2);
        input_descricao.setBackground(cor1);
        input_descricao.setBorder(new LineBorder(cor2, 2));
    ...
    private void acaoEditar (ActionEvent actionEvent) 
    {
        try 
        {
            ...
            transacao.setComentario(descricao);
            transacao.store();
